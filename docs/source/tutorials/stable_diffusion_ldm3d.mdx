...
To generate RGB and depth images with Stable Diffusion LDM3D on Gaudi, you need to instantiate the following instance:
...
from optimum.habana.diffusers import GaudiStableDiffusionLDM3DPipeline
