...
To generate images with Stable Diffusion on Gaudi, you need to instantiate the following instance:
...
To generate RGB and depth images with Stable Diffusion Upscale on Gaudi, you need to instantiate the following instance:
...
scheduler = DDIMScheduler.from_pretrained(model_name_upscale, subfolder="scheduler")
